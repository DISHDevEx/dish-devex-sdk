...
def get_paths_expected():
    return ['respons-logs/pytest/application.gz', 'respons-logs/pytest/gz_files/authenticator.gz',
                'respons-logs/pytest/cloud_controller_manager.gz','respons-logs/pytest/gz_files/cluster.gz',
                'respons-logs/pytest/clusternamespace.gz', 'respons-logs/pytest/gz_files/clusterservice.gz',
                'respons-logs/pytest/container.gz', 'respons-logs/pytest/gz_files/containerfs.gz',
                'respons-logs/pytest/host.gz', 'respons-logs/pytest/gz_files/kube_apiserver.gz',
                'respons-logs/pytest/kube_controller_manager.gz', 'respons-logs/pytest/gz_files/kube_scheduler.gz',
                'respons-logs/pytest/node.gz', 'respons-logs/pytest/gz_files/nodediskio.gz',
                'respons-logs/pytest/nodefs.gz', 'respons-logs/pytest/gz_files/nodenet.gz',
                'respons-logs/pytest/pod.gz', 'respons-logs/pytest/gz_files/podnet.gz']
...
def get_objects_expected(s3_resource):
    return [s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/application.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/authenticator.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/cloud_controller_manager.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/cluster.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/clusternamespace.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/clusterservice.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/container.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/containerfs.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/host.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/kube_apiserver.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/kube_controller_manager.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/kube_scheduler.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/node.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/nodediskio.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/nodefs.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/nodenet.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/pod.gz'),
            s3_resource.Object(bucket_name='respons-logs', key='pytest/gz_files/podnet.gz')]
